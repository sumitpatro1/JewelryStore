...
+function ($) {
  ...
  Layout.prototype.fix = function () {
    ...
    var layoutHeaderHeight = $(Selector.layoutHeader).outerHeight() || 0;
    var neg           = 64 + headerHeight + footerHeight;
    ...
    if ($('body').hasClass(ClassName.fixed)) {
      ...
      if (windowHeight >= sidebarHeight + headerHeight) {
        $(Selector.contentWrapper).css('min-height', windowHeight - neg + 14);
